...
if st.button("Bestätigen", key = "button"):
    ...
    if "user_id" not in st.session_state:
        ...
        add_input(
            st.session_state["user_id"], age, studien, pschlaf, plernzeit, pstress1, pbild, pgesund, philfe, ppausen, pfail, pfreetime, pgoout, ppendel, pfood, psport, st.session_state["pass_probability", 1]
        )
